...
export const MULTI_LESSON_DETAILS_REQUEST = 'MULTI_LESSON_DETAILS_REQUEST'
export const MULTI_LESSON_DETAILS_SUCCESS = 'MULTI_LESSON_DETAILS_SUCCESS'
export const MULTI_LESSON_DETAILS_FAIL = 'MULTI_LESSON_DETAILS_FAIL'
